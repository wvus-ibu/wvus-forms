  ...
  var InputControl = (function(_Component) {
    ...
    function InputControl(props) {
      ...
      return _possibleConstructorReturn(
        this,
        (InputControl.__proto__ || Object.getPrototypeOf(InputControl)).call(
          this,
          props
        )
      );
      ...
      },
      {
        ...
        value: function render() {
          var _props2 = this.props,
            ...
            fieldType =
              _props2$fieldType === undefined ? "text" : _props2$fieldType,
            ...
            handleBlur =
              _props2$handleBlur === undefined
                ? formMethods.handleBlur
                : _props2$handleBlur,
            ...
            showUISuccess =
              _props2$showUISuccess === undefined
                ? formMethods.showUISuccess(fieldState)
                : _props2$showUISuccess,
            _props2$showUIError = _props2.showUIError,
            showUIError =
              _props2$showUIError === undefined
                ? formMethods.showUIError(fieldState)
                : _props2$showUIError,
            _props2$hideMessage = _props2.hideMessage,
            hideMessage =
              _props2$hideMessage === undefined ? false : _props2$hideMessage;

          var readOnly = attributes.readOnly ? attributes.readOnly : false;
          var disabled = attributes.disabled ? attributes.disabled : false;

          var validityClass = showUISuccess
            ? "has-success "
            : showUIError
            ? "has-error "
            : "";
          var requiredStar =
            fieldState.optional == true
              ? ""
              : _react2.default.createElement("sup", null, "*");
          var label = !(fieldType === "hidden")
