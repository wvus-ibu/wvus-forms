(function(global, factory) {
  if (typeof define === "function" && define.amd) {
    define([
      "exports",
      "react",
      "./validation/validation-helpers.js",
      "lodash.merge",
      "./misc/analytics-helpers"
    ], factory);
  } else if (typeof exports !== "undefined") {
    factory(
      exports,
      require("react"),
      require("./validation/validation-helpers.js"),
      require("lodash.merge"),
      require("./misc/analytics-helpers")
    );
  } else {
    var mod = {
      exports: {}
    ...
    return (function(_React$Component) {
      ...
      function _class(props) {
        ...
        var _this = _possibleConstructorReturn(
          this,
          (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, props)
        );
      ...
      _createClass(_class, [
        {
          ...
          value: function componentDidUpdate(prevProps, prevState) {
            ...
            (0, _analyticsHelpers.checkForNewFormErrorsAndFireAnalytics)(
              this.formName,
              this.state,
              prevState
            );
        ...
        },
        {
          ...
          value: function addFieldToState(fieldName) {
            ...
            this.setState(function(prevState) {
              ...
              _this2.validationHelper = (0,
              _validationHelpers.createValidationHelper)(finalState["fields"]);
              return finalState;
            });
          }
        },
          ...
          value: function validateFields() {
            ...
            Object.keys(this.state.fields).map(function(fieldName) {
              ...
              fieldStateUpdate["fields"][fieldName] = {
                isValid: isValid,
                errorMessage: _this3.validationHelper.firstErrorMessage(
                  fieldName
                )
              };
        ...
        },
        {
          ...
          value: function updateFieldsState(fieldsState) {
            ...
            this.setState(function(prevState, props) {
              var newFieldsState = (0, _lodash2.default)(
                {},
                prevState.fields,
                fieldsState["fields"]
              );
              ...
              return (0,
              _lodash2.default)({}, { fields: newFieldsState }, { formValid: formValid });
            });
          }
        },
        {
          ...
          value: function getFormValid(newFieldsState) {
            return (
              Object.keys(newFieldsState).filter(function(field) {
        ...
        },
        {
          ...
          value: function isFormEmpty() {
            ...
            return (
              Object.keys(this.state.fields).filter(function(field) {
        ...
        },
        {
          ...
          value: function setValueChange(fieldName, fieldValue) {
            ...
            this.setState(function(prevState) {
              ...
              return (0,
              _lodash2.default)({}, prevState, { formValid: formValid });
        ...
        },
        {
          ...
          value: function handleBlur(e) {
            ...
            this.setState(function(prevState) {
              ...
              return (0,
              _lodash2.default)({}, prevState, newFieldState, secondInteractionState);
            });
        ...
        },
        {
          ...
          value: function showUISuccess(fieldState) {
            var optionalAndEmpty =
              fieldState.optional && fieldState.value === "";
        ...
        },
        {
          ...
          value: function render() {
            ...
            return _react2.default.createElement(
              "div",
              {
                className: this.props.formWrapperClassName
